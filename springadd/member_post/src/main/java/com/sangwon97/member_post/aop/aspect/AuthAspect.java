package com.sangwon97.member_post.aop.aspect;
...
public class AuthAspect {
  ...
  @Before("@annotation(com.sangwon97.member_post.aop.SigninCheck)")
  ...
  @Before("@annotation(com.sangwon97.member_post.aop.MyPost)")
